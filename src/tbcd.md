...
- 10% of reminted [PSWAP](./pswap) is allocated for the buy-back and burning of TBCD. Similarly, 10% of reminted [VAL](./val) is dedicated to the buy-back and burning of TBCD. Additionally, the [TBC margin](./tbc.md#why-is-the-token-bonding-curve-useful) is directed towards the buy-back and burning of TBCD.
