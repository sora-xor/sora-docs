...
- **SORA Card Mobile: Phase 1**: SORA Card will also be available within the SORA Mobile app, as a dedicated banking backend to manage your balances and top up your card. The first phase of the SORA Card is specific to onboarding, registration and the KYC process. Phase 2 and Phase 3, which include access to a physical and digital card and a fiat banking suite to manage your assets are in the pipeline.𒉡𒉎𒋼
