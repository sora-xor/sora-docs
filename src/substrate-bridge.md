...
This section showcases various scenarios for bidirectional transfers between SORA mainnet and Polkadot.

##### Polkadot -> SORA mainnet

To transfer assets from Polkadot to the SORA network, additional to the `XOR` for the SORA network transaction, you will need to hold `DOT` tokens to pay for the Kusama network transaction fees.
